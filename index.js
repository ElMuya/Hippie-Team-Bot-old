...
client.on("message", async message => {
  ...
  if (message.content.match(prefixMention)) {
    ...
    let embed = new MessageEmbed()
        ...
        ${dev} **Developer:** [Draxler#6145](https://discord.gg/6ePN9bxXRx)
        `)
        .setColor("#FF002B")
...
cooldown.delete(message.author.id)}, cdseconds * 1000)
 ...
 let pree = new MessageEmbed()
      .setDescription(`**${pr} This server is not premium server.** \n${b}${dot} Use \`${prefix}premium Draxler#6145\` to get free 1 year premium.`)
    if (!guild) {
...
require('http').createServer((req, res) => res.end(`
 ...
 |• Author: Draxler#6145         |
 |-----------------------------------------|
 |• Server: https://discord.gg/6ePN9bxXRx  |
 |-----------------------------------------|
 |• Youtube: Deaxler              |
 |-----------------------------------------|
